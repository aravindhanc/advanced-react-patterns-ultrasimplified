 ...
 */
const withClapAnimation = WrapperComponent => {
    class WithClapAnimation extends Component {
        ...
        render() {
            return <WrapperComponent {... this.props} animationTimeline ={this.state.animationTimeline}/>
        }
...
const ClapCount = ({count}) => {
    return <span className={styles.count} id={"clapCount"}>
        + {count}
    </span>
}

const CountTotal = ({countTotal}) => {
    return <span className={styles.total} id="clapCountTotal">
        {countTotal}
    </span>
}
